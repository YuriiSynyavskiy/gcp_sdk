...
from dist.sql_queries import sql_landing_to_staging, sql_staging_to_target
...
with airflow.DAG(
    ...
    load_csv = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table=f"{Variable.get('DATASET_ID')}.{tables.landing_person_table}",
